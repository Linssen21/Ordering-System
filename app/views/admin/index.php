            ...
            <div layout="column" style="width:100%">
              ...
              <div layout="column">
                <md-list style="margin-top:-20px">
                  ...
                  <?php foreach($data['default'] as $row): ?>
                  <md-list-item ng-click="null">
                    <div style="max-height:40px" layout="row">
                      <md-icon style="margin-left:80px">
                        <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                      ...
                      <h4 style="font-weight:400;margin:0px;margin-left:50px" layout-align="center center"><?php echo $row->id; ?></h4>
                      <h4 style="font-weight:400;margin:0px;margin-left:100px" layout-align="center center"><?php echo $row->order_name; ?></h4>
                      <h4 style="font-weight:400;margin:0px;margin-left:100px" layout-align="center center"><?php echo $row->quantity; ?></h4>
