<!-- End of Content Footer (Top-Social Media Links) -->
        ...
        <md-content class="md-padding card-parent" id="mc-footer-copyright" layout="column" layout-xs="column" layout-align="center center">
            <div layout="row" layout-xs="row" layout-align="start center">
                <div layout-align="center center">
                    <p id="footer-copyright" style="text-align:center">Copyright 2018 Gene Rodriguez</p>
                </div>
            </div>
        </md-content>
    ...
    <!-- Web Page Script -->
    <script src="<?php echo URLROOT; ?>/js/ng-main-pages-js.js"></script>
...
<!-- Copyright 2018 Ng Group. All Rights Reserved. -->