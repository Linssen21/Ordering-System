...
<body ng-controller="MyBagCtrl as ctrl" layout="column" ng-cloak="" class="chipsdemoBasicUsage" ng-app="MyApp" style="height: 500px;"
    ...
    <md-content id="main-content">
        ...
        <form action="<?php echo URLROOT; ?>/users/login" method="post">
            ...
            <md-card class="header1-cards md-whiteframe-10dp" layout-align-xs="center center" layout-align-md="center center"  layout-align-sm="center center" layout-align-lg="center center" style="padding:50px;">
                <md-button ng-href="<?php echo URLROOT; ?>/pages/" style="margin-top:-30px;position: relative;align-self:flex-start;left:-40px" class="md-icon-button md-accent" aria-label="Favorite">
                    <md-icon><svg style="width:24px;height:24px" viewBox="0 0 24 24">
                        <path fill="#000000" d="M20,11V13H8L13.5,18.5L12.08,19.92L4.16,12L12.08,4.08L13.5,5.5L8,11H20Z" />
                    </svg></md-icon>
                  </md-button>
                <h2 class="md-display-1" layout-align-xs="center center" layout-align-sm="center center" layout-align-md="center center"  layout-align-lg="center center">Account Login</h2>
                <h2 class="md-title" layout-align-xs="center center" layout-align-sm="center center" layout-align-md="center center"  layout-align-lg="center center" style="text-align:center">Enter your user account information.
                </h2>
                       ...
                       <span><?php echo $data['email_err']; ?></span>
                        <div>
                            <md-input-container class="md-block">
                                ...
                                <input required ng-model="user.email" name="email" type="email" placeholder="Email (required)" ng-required="true">
                            </md-input-container>
                        ...
                        <div style="margin-top:-20px;">
                            <md-input-container class="md-block">
                                ...
                                <input  required ng-model="user.address" name="password" type="password" placeholder="Password" ng-required="true">
                            </md-input-container>
                        </div>
                ...
                <div style="margin-top:10px" layout-align="column">
                    ...
                    <md-button class="md-raised" id="card-button" type="submit" style="background-color:#F9A825; color:white">Login</md-button>
                    <md-button class="md-raised" id="card-button" style="background-color:#F9A825; color:white" ng-href="<?php echo URLROOT; ?>/users/registration">Register</md-button>
